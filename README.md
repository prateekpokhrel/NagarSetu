...
<img src="https://img.shields.io/badge/-NagarSetu-0B1220?style=for-the-badge&labelColor=0B1220" height="4" width="1" alt=""/>
...
<p>
  <a href="https://github.com/yourusername/NagarSetu">
    <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=22&pause=1200&center=true&vCenter=true&width=900&lines=AI+Powered+Smart+City+Governance;Digital+Grievance+Redressal+Platform;Real-Time+Citizen+%E2%86%94+Government+Communication;Built+with+React+%7C+Spring+Boot+%7C+FastAPI+%7C+PostgreSQL" alt="Dynamic Typing Animation" />
  </a>
</p>
...
<p align="center">
  <img src="https://img.shields.io/github/stars/yourusername/NagarSetu?style=for-the-badge&color=E8871E&labelColor=0B1220" alt="Stars">
  <img src="https://img.shields.io/github/forks/yourusername/NagarSetu?style=for-the-badge&color=1B8A5A&labelColor=0B1220" alt="Forks">
  <img src="https://img.shields.io/github/issues/yourusername/NagarSetu?style=for-the-badge&color=C23B33&labelColor=0B1220" alt="Issues">
  <img src="https://img.shields.io/github/license/yourusername/NagarSetu?style=for-the-badge&labelColor=0B1220" alt="License">
</p>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=prateekpokhrel&repo=NagarSetu&style=for-the-badge&color=0B1220" alt="Visitors">
</p>
...
<img src="https://img.shields.io/badge/PostGIS-4169E1?style=flat-square" alt="PostGIS">
<img src="https://img.shields.io/badge/JWT-000000?style=flat-square&logo=jsonwebtokens&logoColor=white" alt="JWT">
<img src="https://img.shields.io/badge/WebSockets-4FC08D?style=flat-square" alt="WebSockets">
...
```mermaid
flowchart LR
    Citizen[Citizen App] -->|Text / Photo / Video / Audio| AI[AI Gateway]
    AI --> Classifier[Model 1: Category Classifier]
    Classifier --> Severity[Model 2: Severity Analyzer]
    Severity --> Advisory[Model 3: Advisory Engine]
    Advisory -->|Self-Resolvable| Citizen
    Advisory -->|Needs Action| Mayor[Mayor Dashboard]
    Mayor -->|Verifies & Assigns| Department[Department Portal]
    Department -->|Status Updates| Citizen
    Department -->|Resolution Proof| Mayor
```
...
sequenceDiagram
    ...
    C->>B: Submit complaint (text/media)
    B->>AI: Forward payload for analysis
    AI->>AI: Classify category
    AI->>AI: Analyze severity
    AI->>AI: Generate advisory
    AI-->>B: Category + Priority + Suggestion
    alt Self-resolvable
        B-->>C: Instant guided solution
    else Needs department action
        B-->>M: Verified complaint alert
        M->>D: Assign with deadline
        D-->>B: Status updates (real-time)
        B-->>C: Live tracking + notifications
        C->>B: Confirm resolution
    end
```
